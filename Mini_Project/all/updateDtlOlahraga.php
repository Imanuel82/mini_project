...
if(isset($_POST['submit'])){
    if(isset($_FILES)){
        ...
        $pathGambar = $targetFolder.$_FILES['gambarDtlOlahraga']['name'];
        ...
        if(!file_exists($_FILES['gambarDtlOlahraga']['tmp_name']) || !is_uploaded_file($_FILES['gambarDtlOlahraga']['tmp_name'])){
            ...
            if(! in_array($file_extension, $allowed_image_extensions)){
                ...
                $query = "UPDATE dtlolahraga SET idDtlOlahraga = '".$idDtlOlahraga."', namaOlahraga = '".$namaOlahraga."', deskOlahraga = '".$deskOlahraga."', gambarDtlOlahraga = '".$gambarDtlOlahraga."', idOlahraga = '".$idOlahraga."' WHERE idDtlOlahraga = '".$idDtlOlahraga."'";
            ...
            <input type="hidden" name="oldGambar" value="<?= $query1["gambarDtlOlahraga"] ?>">
                <ul>
                    <div>
                        ...
                        <input type="text" name="namaOlahraga" id="namaOlahraga" placeholder="Nama Olahraga" required value="<?=$query1['namaOlahraga']?>">
                    </div>
                    <div>
                        <label for="deskOlahraga">Deskripsi</label>
                        <textarea name="deskOlahraga" id="deskOlahraga" cols="60" rows="7" placeholder="Deskripsi Olahraga..."><?=$query1['deskOlahraga']?></textarea>
                    </div>
                    <div>
                        <label for="gambarDtlOlahraga">Gambar Detail</label>
                        <input type="file" name="gambarDtlOlahraga" id="gambarDtlOlahraga">
                        <img src="<?=$query1['gambarDtlOlahraga']?>" width="60px" height="40px" border="1px solid black" alt="">
                    </div>
                    <div>
                        <label for="idOlahraga">ID Olahraga</label>
                        <select name="idOlahraga" id="idOlahraga">
                    ...
                    <div>
                        ...
                        <br>
                        <a href="crudDtlOlahraga.php">Back</a>
                    </div>
                </ul>
            </form>
        </div>
