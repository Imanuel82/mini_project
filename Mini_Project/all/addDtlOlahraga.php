            ...
            <form action="addDtlOlahraga.php" method="POST" enctype="multipart/form-data">
                <ul>
                    <div>
                        ...
                        <input type="text" name="namaOlahraga" id="namaOlahraga" placeholder="Nama Olahraga" required>
                    </div>
                    <div>
                        <label for="deskOlahraga">Deskripsi</label>
                        <textarea name="deskOlahraga" id="deskOlahraga" cols="60" rows="7" placeholder="Deskripsi Olahraga..." required></textarea>
                    </div>
                    <div>
                        <label for="gambarDtlOlahraga">Gambar Detail</label>
                        <input type="file" name="gambarDtlOlahraga" id="gambarDtlOlahraga" placeholder="Gambar Detail Olahraga" required>
                    </div>
                    <div>
